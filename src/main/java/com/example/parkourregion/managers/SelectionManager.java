...
public class SelectionManager {
    ...
    public Location getPos1(UUID player) { return pos1.get(player); }
    public Location getPos2(UUID player) { return pos2.get(player); }

    public boolean isSelectionComplete(UUID player) {
